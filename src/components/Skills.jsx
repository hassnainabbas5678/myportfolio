...
const skills = {
  frontend: [
    ...
    { name: "Bootstrap", level: 70, color: "from-purple-400 to-purple-600" },
    { name: "Tailwind CSS", level: 80, color: "from-cyan-400 to-cyan-600" },
    { name: "JavaScript", level: 90, color: "from-yellow-300 to-yellow-500" },
    { name: "TypeScript", level: 62, color: "from-blue-500 to-blue-700" },
    { name: "React.js", level: 87, color: "from-sky-400 to-sky-600" },
    { name: "Next.js", level: 0, color: "from-gray-500 to-gray-600" },
  ],
  backend: [
    { name: "Node.js", level: 94, color: "from-green-400 to-green-600" },
    { name: "Express.js", level: 92, color: "from-gray-300 to-gray-500" },
  ...
  tools: [
    ...
    { name: "Figma", level: 15, color: "from-pink-400 to-pink-600" },
    { name: "AWS", level: 70, color: "from-yellow-400 to-yellow-600" },
    { name: "Vercel", level: 90, color: "from-gray-700 to-gray-900" },
    { name: "Netlify", level: 100, color: "from-teal-400 to-teal-600" },
    { name: "Database Design", level: 89, color: "from-sky-400 to-sky-600" },
  ],
};
